...
void MenuScene::entry( ) {
	auto background = new Background( L"Menu Background", L"menu_background.png" );
	...
	info.push_back( { L"Play Button", L"game_play.png" } );
	...
	info2.push_back( { L"Exit Button", L"game_exit.png" } );
